...
window.App = {
  ...
  getClaimById: function() {
    ...
    Identity.deployed().then(function(instance) {
      ...
      var claimDetailsHtml = "<tr><th>Owner</th><th>Issuer</th><th>Claim Type</th><th>Claim Status</th><th>Claim Data</th><th>Action</th></tr>";
      claimDetailsHtml = claimDetailsHtml + "<tr><td>" + owner + "</td><td>" + issuer + "</td><td>" + claimType + "</td><td>" + claimStatus + "</td><td>" + claimData + "</td><td>" + action + "</td></tr>";
